...
export const STORE_ITEMS: EconomyItem[] = [
  ...
  store({ id: "velocity-frame", name: "Nimbus Frame", description: "The signature high-tier Nimbus profile frame.", kind: "frame", category: "limited_items", priceBp: 900, style: "velocity", rarity: "legendary", minimumTier: 15, equipable: true, limited: true }),
  ...
  store({ id: "cloud-bit", name: "Gust Gecko", description: "A quick-footed gecko that darts forward when you make progress.", kind: "pet", category: "pet_cosmetics", priceBp: 260, style: "gust-gecko", rarity: "rare", equipable: true }),
