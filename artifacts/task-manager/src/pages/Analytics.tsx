    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        <div className="col-span-2 md:col-span-1 bg-gradient-to-br from-orange-500/10 to-rose-500/10 border-orange-500/20 border p-4 rounded-xl shadow-sm flex flex-col justify-center items-center text-center">
          ...
          <div className="text-3xl font-black text-orange-600">{summary.streakDays}</div>
          <div className="text-xs font-semibold text-orange-600/80 uppercase tracking-wider mt-1">Day Streak</div>
        </div>
      ...
      <div className="grid md:grid-cols-[1fr_350px] gap-8 items-start">
        <div className="bg-card border rounded-2xl shadow-sm p-6">
          <h2 className="text-lg font-semibold mb-6">Velocity History (30 Days)</h2>
              ...
              >
                ...
                <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 rounded-xl border bg-card shadow-sm">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <time className="text-[10px] text-muted-foreground font-mono bg-muted px-2 py-0.5 rounded-full">{format(parseISO(milestone.achievedAt), 'MMM d, yyyy')}</time>
                  </div>
