...
export const ListTasksResponseItem = zod.object({
  ...
  "externalState": zod.string().nullish(),
...
export const CreateDailyHabitResponse = zod.object({
  "id": zod.number(),
  "title": zod.string(),
  "sortOrder": zod.number(),
  "createdAt": zod.string(),
...
export const DeleteDailyHabitResponse = zod.void()
